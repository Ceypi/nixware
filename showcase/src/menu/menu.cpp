...
void menu::render()
{
    ...
    if (!Begin(xorstr("Kami"), NULL, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoTitleBar))
        return;
    ...
    if (BeginTabItem(xorstr("Aimbot")))
    {
        ...
        BeginChild(xorstr("Accuracy"), child_size);
        {
            ...
            Checkbox(xorstr("Enable Backtrack"), &settings::aimbot::accuracy::enable_backtrack);
    ...
    */
    ...
    if (BeginTabItem(xorstr("Visuals")))
    {
        ...
        {   
            ...
            case 0:
            {
                ...
                Checkbox(xorstr("SteamID"), &settings::visuals::players::steamid); ColorEdit4(xorstr("SteamID"), settings::visuals::players::colors::steamid, color_edit4_flags);
                ...
                //Checkbox(xorstr("User Role"), &settings::visuals::players::user_role); ColorEdit4(xorstr("User Role"), settings::visuals::players::colors::user_role, color_edit4_flags);
                ...
                Checkbox(xorstr("Health"), &settings::visuals::players::health); ColorEdit4(xorstr("Health"), settings::visuals::players::colors::health, color_edit4_flags);
            ...
            case 1:
            {
                ...
                Checkbox(xorstr("Health"), &settings::visuals::entity::health); ColorEdit4(xorstr("Health"), settings::visuals::entity::colors::health, color_edit4_flags);
        ...
        {
            Checkbox(xorstr("Spectator List"), &settings::visuals::players::spectator_list);

            Checkbox(xorstr("Console Logger"), &settings::visuals::players::console_logger);

            Checkbox(xorstr("Spotify Playing"), &settings::visuals::players::spotify_playing);

            Checkbox(xorstr("Watermark"), &settings::visuals::players::water_mark);


            float column_width = GetColumnWidth();

            if (Button(xorstr("Test Noti's"), ImVec2(column_width - 10.f, 35.f))) {
                // Convert inline array to a pointer to float
                float* notification_color_ptr = settings::menu::colors::notification_color;

                miscellaneous::notification_system::notify("This is a notification message!", settings::menu::colors::notification_color);
            }
        }
        EndChild();
    ...
    if (BeginTabItem(xorstr("Misc")))
    {
        ...
        BeginChild(xorstr("Globals"), child_size);
        {
            ...
            Checkbox(xorstr("Freecam"), &settings::miscellaneous::globals::free_cam::enable); custom::hotkey(xorstr("Free Cam Hotkey"), &settings::miscellaneous::globals::free_cam::hotkey);
            SliderInt(xorstr("Freecam Distance"), &settings::miscellaneous::globals::free_cam::speed, 1, 5);

           //// Checkbox(xorstr("Extended Backtrack"), &settings::miscellaneous::globals::extended_backtrack::enable);
          //  SliderInt(xorstr("Latency Amount"), &settings::miscellaneous::globals::extended_backtrack::latency, 10, 800);
        }
        EndChild();
        ...
        BeginChild(xorstr("Movement"), child_size);
        {
            ...
            Checkbox(xorstr("Fast walk"), &settings::miscellaneous::movement::fast_walk);
        }
        EndChild();
    ...
    if (BeginTabItem(xorstr("Lua")))
    {
        ...
        std::vector<std::string> file_list = utilities::get_files_from_folder(xorstr("C:/kami/lua/"), search_buffer, xorstr(".lua"));
        ...
        BeginChild(xorstr("Action"), child_size);
        {
            ...
            {
                std::string path = xorstr("C:/kami/lua/") + file_list[selected_item] + xorstr(".lua");
    ...
    if (BeginTabItem(xorstr("Settings")))
    {
        ...
        BeginChild(xorstr("Menu"), child_size);
        {
            ...
            LabelText(xorstr("NotificationColor"));  ColorEdit4(xorstr("NotificationColor"), settings::menu::colors::notification_color, color_edit4_flags);
